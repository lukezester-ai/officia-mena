...
export const metadata: Metadata = {
  ...
  description: 'سياسة الخصوصية لمنصة Officia MENA. تعرّف على كيفية جمع، استخدام، وحماية بياناتك.',
};
        ...
        <div className="space-y-8 text-[var(--color-desert-200)] leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 pr-4 mt-2">
              ...
              <li>الامتثال للالتزامات القانونية والتنظيمية في الاتحاد الأوروبي (GDPR) والمنطقة</li>
          ...
          <section>
            ...
            <p>نحتفظ ببياناتك طالما أن حسابك نشط أو حسبما تقتضي اللوائح القانونية (عادة 6 سنوات وفقاً للوائح الاتحاد الأوروبي). بعد إلغاء حسابك، قد نحتفظ ببعض البيانات للامتثال للالتزامات القانونية قبل حذفها بالكامل.</p>
          </section>
