    ...
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div className="grid min-h-[620px] gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
        ...
        <aside className="space-y-4">
          ...
          <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-5 text-sm text-emerald-900"><div className="flex items-center gap-2 font-black"><ShieldCheck size={17} /> Фаза 3: проактивен контрол</div><p className="mt-2 leading-6">Maestro следи просрочия, ZATCA забавяния, HR документи, ниски наличности и срокове. Сигналите са дедуплицирани, могат да се отложат или приключат и оставят audit следа.</p></div>
        </aside>
      </div>
    </div>
  );
