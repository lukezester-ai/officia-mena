...
import { FileSignature, ArrowRight, Save, Calculator, Sparkles, Loader2, Plus, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12" dir="rtl">
      ...
      <div className="flex items-center gap-4">
        <Link href="/dashboard/quotations" className="p-2 bg-white/5 rounded-full border border-white/10 hover:bg-white/10 transition-colors">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">أضف المنتجات يدوياً أو استخدم الذكاء الاصطناعي لتعبئة العرض</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-primary/20 to-transparent border border-primary/30 rounded-3xl p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="flex gap-3 relative z-10">
          <input 
            ...
            placeholder="مثال: عرض سعر لـ 5 سيرفرات بقيمة 20000 للواحد لشركة المستقبل..."
      ...
      <div className="bg-card rounded-3xl border border-white/5 shadow-xl overflow-hidden">
        <div className="p-8 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-bold text-muted-foreground mb-2">الرقم الضريبي (TRN) (اختياري)</label>
                <input 
                  type="text" 
                  value={clientTrn}
          ...
          <div>
            <div className="flex items-center justify-between border-b border-white/10 pb-2 mb-4">
              <h2 className="text-lg font-bold text-white flex items-center gap-2">
                <FileSignature size={18} className="text-primary" /> المنتجات والخدمات
              </h2>
              <button 
                onClick={addItem}
        ...
        <div className="p-6 bg-black/20 border-t border-white/5 flex flex-col sm:flex-row gap-4">
          ...
          >
            <Save size={20} /> حفظ وإرسال عرض السعر
          </button>
        </div>
      </div>
    </div>
