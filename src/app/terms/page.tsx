      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="space-y-8 text-[var(--color-desert-200)] leading-relaxed">
          ...
          <section>
            ...
            <p>Officia MENA هي منصة محاسبية متكاملة تعمل بالذكاء الاصطناعي، مصممة للشركات في منطقة الشرق الأوسط وشمال أفريقيا. تشمل الخدمات: إدارة الفواتير، المصروفات، المخزون، الرواتب، النقاط البيع، الالتزام الضريبي (ZATCA)، والتقارير المالية.</p>
          </section>
          ...
          <section>
            ...
            <p>تخضع هذه الشروط للقوانين واللوائح في المملكة العربية السعودية. يتم حل أي نزاعات عبر المحاكم المختصة في الرياض، المملكة العربية السعودية.</p>
          </section>
